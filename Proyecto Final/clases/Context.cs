    ...
    public class RestauranteDataContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            try
            {
                ...
                optionsBuilder.UseSqlServer("Server=DESKTOP-53RV4NS;Database=la_delicia ;Trusted_Connection=SSPI;MultipleActiveResultSets=true;Trust Server Certificate=true");
